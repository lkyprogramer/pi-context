...
async function probeInstalledExtension(piBin, extensionPath, cwd, env, signal, timeoutMs) {
  ...
  const source = [
    ...
    "let aborted = false;",
    "const cwd = process.env.PCR_EXTENSION_CWD;",
    ...
    "  getCwd() { return cwd; },",
    "};",
    "const ctx = { abort() { aborted = true; }, cwd, sessionManager, model: { provider: 'openclaw', id: 'Qwen3.8-27B-WORK', contextWindow: 200192, maxTokens: 16384 }, thinkingLevel: 'off', signal: undefined };",
