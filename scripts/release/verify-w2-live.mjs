...
if (report.sample.attempted !== 300 || report.sample.completedPairs !== 300 - failures.length || report.sample.scored !== report.sample.completedPairs || report.sample.failed !== failures.length) fail("PCR_W2_LIVE_COUNTS_MISMATCH");
