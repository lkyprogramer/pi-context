// Proposed interfaces. R02 copies these definitions to src/projection/view-contracts.ts.
// This file is a specification, not an already implemented runtime module.
